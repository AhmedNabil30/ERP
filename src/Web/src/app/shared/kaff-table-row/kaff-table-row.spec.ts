...
@Component({
  ...
  template: `
    <kaff-table-row [columns]="'100px 100px'">
...
/**
 * AC-924-B: the projected `.row-price-label` markup renders through `kaff-table-row` unchanged — the
 * actual hide-at-desktop/show-at-mobile behaviour is a `width < 48rem` media query in
 ...
 * query the way a real viewport does.
 */
