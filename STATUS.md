...
**HEAD** `b95a931` · ⚠️ working tree DIRTY
...
| [KAFF-129](stories/slice-1-foundation/KAFF-129-partition-audit-records-by-month.md) | 8 | ⚪ NOT-BUILT | none | `-` | 2026-09-07 | Partition `audit_records` by month, from the start |
| [KAFF-300](stories/slice-1-foundation/KAFF-300-the-section-15-worked-example.md) | 5 | ⚪ NOT-BUILT | none | `-` | 2026-09-07 | The §15 worked example as a fixture — present and failing before anything else is built |
