...
⚠️ **12 points of slice-1 code carry no independent verdict** — 9 built-and-unlooked-at plus the 3
lapsed. That debt did not go away when the slice closed; it moved into slice 2's first sprint.
...
**HEAD** `9cf7cfe` · ⚠️ working tree DIRTY
